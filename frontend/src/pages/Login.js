      ...
      <div className="mx-auto container p-7">
        <div className="bg-white p-4 py-5 w-full max-w-md mx-auto">
          ...
          <form className="w-full max-w-md mx-auto pt-8">
            ...
            <button type="submit" className="bg-red-500 hover:bg-red-700 text-white px-6 py-2 w-full max-w-[140px] rounded-full hover:scale-105 ">
                Login
            </button>
          </form>
            <div className="flex justify-center items-center mt-4">
                <p className="mr-2">Don't have an account?</p>
                <Link to={"/sign-up"} className="hover:underline text-red-400 hover:text-red-500">Sign Up</Link>
                </div>
        </div>
      </div>
    </section>
